...
tu es expert devops, je remarque que lorsque je change de tableau excel avec des noms de colonne différent et informations différente j'ai une erreur qui s'affiche lorsque je charge le document "aucun données valide". Pour que tu comprennes bien le fichier se nommant "Tableau contact" n'affiche pas d'erreur cependant le fichier "contact-école" affiche l'erreur d'aucune donnée valide. Cherche l'origine du problème et élabore une stratégie pour standardisé la prise en charge des fichiers, le système devra reconnaire le titre de chaque colonne, tu ajoutera également une fenêtre qui demande à l'utilisateur de remplire le message automatique à envoyer, il y a aura des puces avec le nom de chaque colonne dans une barre au dessus et pendant que l'utilisateur écrit son message il pourra placer les puces là où il veux, chaque puce stocke son information issu du tableau excel.